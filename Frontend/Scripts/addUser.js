...
form.addEventListener('submit', async (event) =>
{
    ...
    } else
    {
        ...
        await fetch(`http://172.16.191.211:3000/user/insert?firstName=${firstName}&lastName=${lastName}&email=${email}&password=${password}&role=${userRole}`, myInit).then(function (response)
        {
